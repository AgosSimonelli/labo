...
## Preguntas
## - ¿Qué tipo de muestre se tomó? Undersampling - Algunos lo piensan como oversampling.
...
#Sacar el sampleo para el experimento. 
#Vamos a tener mas ganancia.  Sacar el area bajo la curva y poner la formula de ganancia. 
#
