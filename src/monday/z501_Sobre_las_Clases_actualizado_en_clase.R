...
# Poner sus semillas
semillas <- c(238001, 257687, 564227, 785501, 956341, 17, 22, 42, 127, 1298, 11, 1950, 1245, 165, 777, 123, 199, 200, 342, 555)
# Poner la carpeta de la materia de SU computadora local
...
ggplot(dataset[ctrx_quarter < 300, ], aes(x = ctrx_quarter)) +
  facet_grid(clase_ternaria ~ .) +
  geom_density()
#Veo que baja+1 y baja+2 son muy similares.
...
## Preguntas
## ¿Obtuvo una importante mejora en su modelo? NO!!
