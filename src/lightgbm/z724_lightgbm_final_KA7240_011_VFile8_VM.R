...
#Que corrio en la VM - salida en:  HT7231_010_VM - Lo hago con los mejores HP hasta la it. 134
#la mejor es la 125
#defino los parametros de la corrida, en una lista, la variable global  PARAM
#  muy pronto esto se leera desde un archivo formato .yaml
PARAM <- list()
PARAM$experimento  <- "KA7240_011_Vfile8_OB_VM"
...
PARAM$finalmodel$learning_rate     <-     0.0216607693345971   #0.0142501265
PARAM$finalmodel$num_iterations    <-    361  #615
PARAM$finalmodel$num_leaves        <-   2579  #784
PARAM$finalmodel$min_data_in_leaf  <-   832  #5628
#PARAM$finalmodel$lambda_l1        <-  1
#PARAM$finalmodel$lambda_l2        <- 4
PARAM$finalmodel$feature_fraction  <-      0.492412162974244  #0.8382482539
