...
hs <- makeParamSet( 
         makeNumericParam("learning_rate",    lower=    0.005, upper=    0.4),
         makeNumericParam("feature_fraction", lower=    0.2  , upper=    1.0),
         makeIntegerParam("lambda_l1",        lower=    0.0  , upper= 5),
         makeIntegerParam("lambda_l2",        lower=    0.0  , upper= 5),
         makeIntegerParam("min_data_in_leaf", lower=    0L   , upper=  10000L),
         makeIntegerParam("num_leaves",       lower=   14L   , upper=  1424L),
