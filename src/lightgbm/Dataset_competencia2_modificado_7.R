...
mis_variables <- c(
                   #"mcuentas_saldo", la saco por DD
                   "mactivos_margen",
                   "mpasivos_margen",
                   "mcaja_ahorro",
                   #"mcuenta_corriente", a saco por DD
                   "mrentabilidad",
                   "mautoservicio",
...
#grabo el dataset
fwrite( nuevodf,
        "dataset_competencia2_FE7.csv.gz",
        logical01= TRUE,
        sep= "," )
