...
PARAM <- list()
PARAM$experimento  <- "KA7240_012B_Vfile8_OB_VM"
...
PARAM$finalmodel$learning_rate     <-     0.0050106261703098   #0.0142501265
PARAM$finalmodel$num_iterations    <-    3125  #615
PARAM$finalmodel$num_leaves        <-   2506  #784
PARAM$finalmodel$min_data_in_leaf  <-   1316  #5628
#PARAM$finalmodel$lambda_l1        <-  1
#PARAM$finalmodel$lambda_l2        <- 4
PARAM$finalmodel$feature_fraction  <-      0.529165532690531  #0.8382482539
