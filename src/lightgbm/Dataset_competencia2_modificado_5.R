...
#En este script hago las mismas variables que para la C1 y a diferencia del modificado_4, en este 
#NO BORRO las variables que vi que tenian Data Drifting (para ver si con el rankeo 
#va mejor que borrandolas - script .modificado_3)
...
dataset [ , ':=' ( ccomisiones_mantenimiento=NULL, ccomisiones_otras=NULL, cprestamos_personales=NULL , cprestamos_prendarios=NULL, cprestamos_hipotecarios=NULL , mprestamos_personales=NULL, mprestamos_prendarios=NULL, mprestamos_hipotecarios=NULL , Master_mlimitecompra=NULL, Visa_mlimitecompra=NULL , Master_cconsumos=NULL, Visa_cconsumos=NULL , Master_mconsumospesos=NULL , Visa_mconsumospesos=NULL, cseguro_vida=NULL , cseguro_auto=NULL, cseguro_vivienda=NULL, cseguro_accidentes_personales=NULL, cpagodeservicios=NULL, cpagomiscuentas=NULL, mpagodeservicios=NULL,  mpagomiscuentas=NULL, ctarjeta_visa_descuentos=NULL, ctarjeta_master_descuentos=NULL,  mtarjeta_visa_descuentos=NULL, mtarjeta_master_descuentos=NULL)]
