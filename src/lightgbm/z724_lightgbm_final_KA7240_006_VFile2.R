...
#z723_lightgbm_binaria_BO_corrido_KA7240__006_Vfile2

#defino los parametros de la corrida, en una lista, la variable global  PARAM
#  muy pronto esto se leera desde un archivo formato .yaml
PARAM <- list()
PARAM$experimento  <- "KA7240_006_Vfile2_conOB"
...
PARAM$finalmodel$learning_rate     <-     0.005022393   #0.0142501265
PARAM$finalmodel$num_iterations    <-    2265  #615
PARAM$finalmodel$num_leaves        <-   970  #784
PARAM$finalmodel$min_data_in_leaf  <-   743  #5628
#PARAM$finalmodel$lambda_l1        <-  1
#PARAM$finalmodel$lambda_l2        <- 4
PARAM$finalmodel$feature_fraction  <-      0.201569961636184  #0.8382482539
