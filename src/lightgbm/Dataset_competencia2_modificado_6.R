...
#En este script hago las mismas variables que para la C1, hago rankeo, 
#Borro estas 4 variables que tienen DD que en script anterior quedaron rankeadas.
##"mcuentas_saldo", ALTA
#"mcuenta_corriente", ALTA
#"Master_mfinanciacion_limite",
#"Visa_mfinanciacion_limite",
#Y borro las que tenia listadas de antes. 
...
#grabo el dataset
fwrite( nuevodf,
        "dataset_competencia2_FE6.csv.gz",
        logical01= TRUE,
        sep= "," )
