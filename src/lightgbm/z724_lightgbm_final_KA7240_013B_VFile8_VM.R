...
#Que corrio en la VM - salida en:  HT7231_013_VM - Lo hago con los mejores HP - 235 
#  muy pronto esto se leera desde un archivo formato .yaml
PARAM <- list()
PARAM$experimento  <- "KA7240_013B_Vfile8_OB_VM"
...
PARAM$finalmodel$learning_rate     <-     0.00526461794490666   #0.0142501265
PARAM$finalmodel$num_iterations    <-    2015  #615
PARAM$finalmodel$num_leaves        <-   2413  #784
PARAM$finalmodel$min_data_in_leaf  <-   178  #5628
#PARAM$finalmodel$lambda_l1        <-  1
#PARAM$finalmodel$lambda_l2        <- 4
PARAM$finalmodel$feature_fraction  <-      0.36547119059055  #0.8382482539
