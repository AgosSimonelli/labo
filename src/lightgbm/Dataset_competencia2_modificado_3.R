...
#En este script no hago el rankeo, hago el FE de la C1 y después borro las varibales que vi que tenian
#Data Drifting
...
#ESTO NO LO CORRI PORQUE ME DA ERROR!! 
#"ctrx_quarter",
...
#  dataset[, (paste(prefix, var, sep = "")) := ntile(get(var), 50)]
#}
...
#grabo el dataset
fwrite( dataset,
        "dataset_competencia2_FE.csv.gz",
        logical01= TRUE,
        sep= "," )
