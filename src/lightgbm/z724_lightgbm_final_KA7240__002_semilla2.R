...
PARAM <- list()
PARAM$experimento  <- "KA7240_002_semilla2"

PARAM$input$dataset       <- "./datasets/competencia2_2022.csv.gz"
PARAM$input$training      <- c( 202103 )
PARAM$input$future        <- c( 202105 )

#Uso los Hp de z723_lightgbm_binaria_BO_corrido
...
PARAM$finalmodel$learning_rate     <-      0.0248  #0.0142501265
PARAM$finalmodel$num_iterations    <-    328  #615
PARAM$finalmodel$num_leaves        <-   392  #784
PARAM$finalmodel$min_data_in_leaf  <-   444  #5628
PARAM$finalmodel$feature_fraction  <-      0.852 #0.8382482539
