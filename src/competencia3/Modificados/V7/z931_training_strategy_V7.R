...
PARAM  <- list()
PARAM$experimento <- "TS9310_7"

PARAM$exp_input  <- "FE9250_6"
PARAM$future       <- c( 202107 )


PARAM$final_train  <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202012, 202101, 202102, 202103, 202104, 202105)


PARAM$train$training     <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202012,  202101, 202102, 202103)
