...
setwd("C:\\Users\\Administrator\\Desktop\\Maestria\\EyF\\")  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
pdf(file = "./exp/work/arbol_canaritos_desconfiado.pdf", width=28, height=4)
