...
PARAM  <- list()
PARAM$experimento <- "TS9320_C4_CC09_OTS"

PARAM$exp_input  <- "FE9250_C4_RF_CC09_OTS"
PARAM$future       <- c( 202109 )


PARAM$final_train  <- c( 201907,201908,201909,201910,201911,201912, 202011, 202012, 202101, 202102, 202103,202104, 202105, 202106, 202107)
...
dataset_input  <- paste0( "./exp/Competencia_Final/", PARAM$exp_input, "/dataset.csv.gz" )
