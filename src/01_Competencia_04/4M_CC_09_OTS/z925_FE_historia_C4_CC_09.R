...
PARAM  <- list()
PARAM$experimento <- "FE9250_C4_RF_CC09_OTS"

PARAM$exp_input  <- "DR9141_CFinal"
...
TendenciaYmuchomas  <- function( dataset, cols, ventana=4, tendencia=TRUE, minimo=FALSE, maximo=FALSE, promedio=TRUE, 
