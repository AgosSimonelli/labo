...
PARAM <- list()
PARAM$experimento <- "ZZ1292_ganancias_CC_09_semillerio"
PARAM$exp_input <- "ZZ9410_C4_CC_09_semillerio"
...
dir.create(paste0(base_dir, "exp/Compentencia_Final/", PARAM$experimento, "/"), showWarnings = FALSE)
