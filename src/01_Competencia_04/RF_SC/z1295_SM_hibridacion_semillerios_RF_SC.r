...
PARAM <- list()
PARAM$experimento <- "ZZ1292_hibridacion_semillerio_kaggle_m1_y_m2"
...
PARAM$archivos <- c(
  "../ZZ1292_hibridacion_semillerio_kaggle_m1_RF_SC/ZZ1292_hibridacion_semillerio_kaggle_m1_RF_SC_rank_predicciones.csv",
  "../ZZ1292_hibridacion_semillerio_kaggle_m2_C4_SC/ZZ1292_hibridacion_semillerio_kaggle_m2_C4_SC_rank_predicciones.csv"
)

PARAM$corte <- 10100 # cantidad de envios
