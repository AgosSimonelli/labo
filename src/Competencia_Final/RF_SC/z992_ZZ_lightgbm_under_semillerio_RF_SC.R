...
PARAM <- list()
PARAM$experimento <- "ZZ9410_semillerio_ensamble_RF_SC"
PARAM$exp_input <- "HT9420_RF_SC"

# PARAM$modelos  <- 2
PARAM$modelo <- 1 # se usa el mejor de la OB, pero a futuro podria variar esto
PARAM$semilla_primos <- 238001
PARAM$semillerio <- 62 # ¿De cuanto será nuestro semillerio?
PARAM$indice_inicio_semilla <- 1
PARAM$indice_fin_semilla <- 62
