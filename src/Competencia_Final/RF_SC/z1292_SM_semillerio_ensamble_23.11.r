...
PARAM <- list()
PARAM$experimento <- "001_ZZ1292_hibridacion_semillerio_kaggle_m1_RF_SC"
PARAM$exp_input <- "ZZ9410_semillerio_ensamble_RF_SC"
...
for (archivo in archivos) {
  ...
  ksemilla <- strtoi(strsplit(archivo, "_")[[1]][6])
