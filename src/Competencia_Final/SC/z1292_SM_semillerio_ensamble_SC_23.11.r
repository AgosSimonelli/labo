...
PARAM <- list()
PARAM$experimento <- "001_ZZ1292_hibridacion_semillerio_kaggle_m2_C4_SC"
PARAM$exp_input <- "ZZ9410_C4_SC_semillerio"
...
ksemillas <- lapply(strsplit(archivos, "_"), function(partes_nombre_archivo) {
  ...
  return(partes_nombre_archivo[5]) # la posicion de la semilla en el nombre es 7
})
...
for (archivo in archivos) {
  ...
  ksemilla <- strtoi(strsplit(archivo, "_")[[1]][5])
