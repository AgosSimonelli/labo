...
modelo  <- rpart(formula=   "clase_binaria1 ~ . -clase_ternaria -mcomisiones_mantenimiento -Visa_mpagado ",
...
dapply[ , Predicted := as.numeric( prob_baja2 > 0.0579) ]

#genero el archivo para Kaggle
#primero creo la carpeta donde va el experimento
dir.create( "./exp/" )
dir.create( "./exp/KA5006" )

fwrite( dapply[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
        file= "./exp/KA5001/K501_006.csv",
        sep=  "," )
