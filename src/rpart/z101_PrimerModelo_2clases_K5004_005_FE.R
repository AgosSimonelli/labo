...
for (var in mis_variables) {
  dtrain[, (paste(prefix, var, sep = "")) := ntile(get(var), 150)]
  dapply[, (paste(prefix, var, sep = "")) := ntile(get(var), 150)]
}
...
modelo_bin2 <- rpart(clase_binaria2 ~ . -clase_ternaria -cforex_buy -cforex_sell -mcomisiones_mantenimiento -mcomisiones_otras -ccomisiones_mantenimiento -ccomisiones_otras  -mtarjeta_visa_descuentos -mtarjeta_master_descuentos  -ctarjeta_visa_descuentos -ctarjeta_master_descuentos -mpagodeservicios-mpagomiscuentas  -cpagodeservicios -cpagomiscuentas -cseguro_vida -cseguro_auto -cseguro_vivienda -cseguro_accidentes_personales  -Master_cconsumos -Visa_cconsumos -mcomisiones_mantenimiento -Visa_mpagado -numero_de_cliente -mprestamos_personales -cprestamos_personales -cprestamos_prendarios -cprestamos_hipotecarios -mprestamos_prendarios -mprestamos_personales -mprestamos_hipotecarios -Master_mlimitecompra -Visa_mlimitecompra,
                     data = dtrain2,
                     xval = 0,
                     control = parametros)
...
#Recommended parameters:
#  maxdepth=7; minsplit=134; minbucket=429
#Objective: y = 222664000.000
#...............................................
...
fwrite( dapply[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
        file= "./exp/KA5004_FE/K5004_005.csv",
        sep=  "," )
