...
PARAM  <- list()
PARAM$experimento  <- "ZZ9420_EXP_CC_08_08"
PARAM$exp_input  <- "HT9420_EXP_CC_08"
...
dir.create( paste0( base_dir, "exp/01Experimento/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( base_dir, "exp/01Experimento/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO

#leo la salida de la optimizaciob bayesiana
arch_log  <- paste0( base_dir, "exp/01Experimento/", PARAM$exp_input, "/BO_log.txt" )
tb_log  <- fread( arch_log )
setorder( tb_log, -ganancia )

#leo el nombre del expermento de la Training Strategy
arch_TS  <- paste0( base_dir, "exp/01Experimento/", PARAM$exp_input, "/TrainingStrategy.txt" )
TS  <- readLines( arch_TS, warn=FALSE )

#leo el dataset donde voy a entrenar el modelo final
arch_dataset  <- paste0( base_dir, "exp/01Experimento/", TS, "/dataset_train_final.csv.gz" )
dataset  <- fread( arch_dataset )

#leo el dataset donde voy a aplicar el modelo final
arch_future  <- paste0( base_dir, "exp/01Experimento/", TS, "/dataset_future.csv.gz" )
