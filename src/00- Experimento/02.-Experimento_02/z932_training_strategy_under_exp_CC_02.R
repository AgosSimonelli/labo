...
#Para este caso la FE historica que uso es la misma que para V6

#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_EXP_CC_02"

PARAM$exp_input  <- "FE9250_EXP_CC_02"
...
PARAM$train$semilla_sampling  <- 257687
PARAM$train$semilla_under     <- 238001
...
dataset_input  <- paste0( "./exp/01Experimento/", PARAM$exp_input, "/dataset.csv.gz" )
...
dir.create( paste0( "./exp/01Experimento/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp/01Experimento/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
